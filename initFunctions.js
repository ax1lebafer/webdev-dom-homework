...
export function initLikeCommentListeners({ persons, renderComments, postCommentInfo }) {
...
export function initDeleteLastComentListener({ persons, renderComments, postCommentInfo }) {
